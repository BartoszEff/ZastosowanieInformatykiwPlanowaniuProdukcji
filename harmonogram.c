...
void brute_force_rekurencja(int *kolejnosc_zadan, int start, int liczba_zadan, int liczba_maszyn,int *czasy_przetwarzania, int *typy_zadan, int *czasy_przezbrojen, int *najlepszy_makespan, int *najlepsze_rozwiazanie) {
...
EXPORT void brute_force(int *kolejnosc_zadan, int start, int liczba_zadan, int liczba_maszyn,int *czasy_przetwarzania, int *typy_zadan,int *czasy_przezbrojen, int *najlepszy_makespan, int *najlepsze_rozwiazanie) {
    ...
    *najlepszy_makespan = INT_MAX;
    ...
    brute_force_rekurencja(aktualna, start, liczba_zadan, liczba_maszyn,
                           czasy_przetwarzania, typy_zadan, czasy_przezbrojen,
